...
class Comms:
   ...
   def listenToDistributedServers(self):
      if self.isCentral:
            self.mySocket.listen(4)
            distributed1Connected = False
            distributed2Connected = False
            distributed3Connected = False
            distributed4Connected = False
            while True:
               print(
